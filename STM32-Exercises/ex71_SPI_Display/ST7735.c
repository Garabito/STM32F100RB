...
static const struct ST7735_cmdBuf initializers[] = {
  ...
  { 0xE0, 0, 16, {0x02, 0x1C, 0x07, 0x12, 0x37, 0x32, 0x29, 0x2D,
    ...
    void ST7735_init()
    {
      ...
      //LCD_SCE
      GPIO_InitStructure.GPIO_Pin = GPIO_PIN_SCE; //LCD Select
      ...
      //LCD_DC
      GPIO_InitStructure.GPIO_Pin = GPIO_PIN_DC; //LCD Data/Control ( A0 )
      GPIO_Init(LCD_PORT, &GPIO_InitStructure);

      //LCD_BKL
      GPIO_InitStructure.GPIO_Pin = GPIO_PIN_BKL; //LCD Backlight control
